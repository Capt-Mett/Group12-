<template>
    <div class="main">
        ...
        <el-dialog :visible.sync="isEditDialogShow" width="45%" center>
            ...
            <div style="display: flex;align-items: center;">
                <el-button  style="margin: auto; margin-top: 2vh; width: 50%" type="primary" @click="handleEdit">确认提交</el-button>
            </div>
        </el-dialog>
...
<!--                    </el-col>-->
            ...
            <div class="table">
                <el-table :data="tableList" style="width: 95%" height="100%" max-height="100%" empty-text="无匹配行"
                    ...
                    <el-table-column label="team Id" min-width="10" :show-overflow-tooltip="true">
                        <template slot-scope="scope">
                            <span>{{ scope.row.teamId }}</span>
                        </template>
                    </el-table-column>
                    <el-table-column label="manager Id" min-width="10" :show-overflow-tooltip="true">
                        <template slot-scope="scope">
                            <span>{{ scope.row.managerId }}</span>
                        </template>
                    </el-table-column>
                    <el-table-column label="internal flag" min-width="10" :show-overflow-tooltip="true">
                        <template slot-scope="scope">
                            <span>{{ scope.row.internalFlag }}</span>
                        </template>
                    </el-table-column>
...
export default {
    ...
    methods: {
        getTableData() {
            this.$http.getAllTeams().then(res => {
