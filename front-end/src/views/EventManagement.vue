            ...
            <div class="search">
                <el-row :gutter="20" style="margin-top: 20px;">
                    ...
                    <el-col :span="3" :offset="14">
                        <el-input clearable size="mini" placeholder="eventName" suffix-icon="el-icon-search"
                                  v-model="searchCondition.eventName" @change="getTableData"></el-input>
                    </el-col>
                    <el-col :span="3" :offset="0">
                        <el-input clearable size="mini" placeholder="eventType" suffix-icon="el-icon-search"
                                  v-model="searchCondition.eventType" @change="getTableData"></el-input>
                    </el-col>
                    <el-col :span="3" :offset="0">
                        <el-input clearable size="mini" placeholder="location" suffix-icon="el-icon-search"
                                  v-model="searchCondition.location" @change="getTableData"></el-input>
                    </el-col>
...
export default {
    ...
    methods: {
        getTableData() {
            this.$http.getList(this.searchCondition).then(res => {
