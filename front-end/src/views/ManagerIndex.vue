<template>
    <div class="container">
        <div class="top">
            <div class="logo">
                <span style="font-weight: 500; font-size: 1rem">xxx SYSTEM</span>
            </div>
            <div class="space"></div>
            ...
            <div class="info">
                <el-popover placement="top" width="100" v-model="pageState.isInfoHintShow">
                    ...
                    <div style="text-align: right; margin: 0">
                        <el-button size="mini" type="text" @click="pageState.isInfoHintShow = false">No</el-button>
        ...
        <div class="center">
            <div class="aside" @mouseenter="pageState.isCollapse = false" @mouseleave="pageState.isCollapse = true">
                <el-menu style="height: 100%" :default-active="$route.path" class="el-menu-vertical-demo"
                    ...
                    <el-menu-item index="/ManagerIndex" @click="$router.replace('/ManagerIndex')">
                        <i class="el-icon-s-custom"></i>
                        <span slot="title">User Management</span>
                    </el-menu-item>
                    <el-menu-item index="/ManagerIndex/TeamManagement" @click="$router.replace('/ManagerIndex/TeamManagement')">
                        <i class="el-icon-s-grid"></i>
                        <span slot="title">Team Management</span>
                    </el-menu-item>
                    <el-menu-item index="/ManagerIndex/EventManagement" @click="$router.replace('/ManagerIndex/EventManagement')">
                        <i class="el-icon-tickets"></i>
                        <span slot="title">Event Management</span>
                    </el-menu-item>
                    <el-menu-item index="/ManagerIndex/ManagerProductCategory" @click="$router.replace('/ManagerIndex/ManagerProductCategory')">
                        <i class="el-icon-suitcase"></i>
                        <span slot="title">Product Management</span>
                    </el-menu-item>
                    <el-menu-item index="/ManagerIndex/MangerOrder" @click="$router.replace('/ManagerIndex/MangerOrder')">
